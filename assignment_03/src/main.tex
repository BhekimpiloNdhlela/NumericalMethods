...
\begin{figure}[h!]
  \centering
  \begin{subfigure}{\linewidth}
    \includegraphics[width=\linewidth]{not_knot_i.png}
    \caption{These are the J_v(1) and P(v) curves/ graphs }
  \end{subfigure}
\end{figure}
...
\begin{figure}[h!]
  \centering
  \begin{subfigure}{\linewidth}
    \includegraphics[width=\linewidth]{clamped_ii.png}
    \caption{These are the J_v(1) and P(v) curves/ graphs }
  \end{subfigure}
\end{figure}


\textbf{ \\ \\ The Bessel Function was perfectly interpolated when the clamped Cubic Spline was used to interpolate the the Function since\\
                the error:  $J_x(1) - P(x) = 0 $. and also where it was given that: \\ $s^' (1) = s^' (3) = 0$}
